...
Chrome and Edge store screenshots should make PiP Anywhere feel like a focused
...
Focus on the icon, product name, and a single floating PiP window.
...
Use a wide video scene with a PiP window floating out of the player.
